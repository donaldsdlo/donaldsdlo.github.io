...
#+HUGO_TAGS: Iosevka 字体 编程字体
#+CATEGORIES: Iosevka 字体
#+DATE: 2026-06-29
#+AUTHOR: Donald Lo
...
[[https://github.com/be5invis/Iosevka][Iosevka]]（发音 [ˌjɔˈseβ.kʰa]）是由 [[https://github.com/be5invis][Belleve Invis]]（aka be5invis）设计和开发的一款开源字体家族。它是一个 =无衬线 + 衬线= 、 =等宽 + 准比例= 的混合型字体家族，专门为 =编写代码= 、 =终端使用= 和 =技术文档排版= 而设计。
...
Iosevka 使用 [[https://github.com/be5invis/Iosevka/blob/main/LICENSE.md][SIL Open Font License 1.1]] 开源许可，可以自由使用、修改和分发。
...
- =连字支持= — 支持 ~>=~ ~===~ ~->~ ~=>~ 等编程常见符号的连字（Ligatures），并且提供 =21 种语言特定连字集= ，覆盖 JavaScript、Haskell、Julia、F#、Coq 等语言。
...
** Iosevka Slab / Term Slab / Fixed Slab
...
1. 访问 [[https://github.com/be5invis/Iosevka/releases][Iosevka Releases 页面]]
...
1. 从 [[https://github.com/be5invis/Iosevka/releases][Releases]] 下载字体包
...
- [[https://mirrors.tuna.tsinghua.edu.cn/github-release/be5invis/Iosevka][清华大学 TUNA 镜像]] — =https://mirrors.tuna.tsinghua.edu.cn/github-release/be5invis/Iosevka=
- [[https://mirrors.nju.edu.cn/github-release/be5invis/Iosevka][南京大学 NJU 镜像]] — =https://mirrors.nju.edu.cn/github-release/be5invis/Iosevka=
...
更简单的方式——使用 [[https://github.com/mickeynp/ligature.el][ligature.el]] 插件：
...
如果你不想从源码构建，Iosevka 提供了在线定制工具 [[https://be5invis.github.io/Iosevka/customizer][Iosevka Customizer]]，可以在浏览器中：
...
* Sarasa Gothic — CJK 用户的选择

Iosevka 本身 =不包含= 中文、日文、韩文（CJK）字符。如果你需要 CJK 支持，同一个作者开发了 [[https://github.com/be5invis/Sarasa-Gothic][Sarasa Gothic]]——将 Iosevka 与 Source Han Sans（思源黑体）合并的字体家族。
...
- [[https://typeof.net/Iosevka/][Iosevka 官网]] — 在线预览和 Customizer
- [[https://github.com/be5invis/Iosevka][Iosevka GitHub 仓库]] — 源码、Issue、Releases
- [[https://github.com/be5invis/Iosevka/blob/main/doc/custom-build.md][自定义构建文档]] — 完整的 private-build-plans.toml 配置参考
- [[https://github.com/be5invis/Iosevka/blob/main/doc/stylistic-sets.md][Stylistic Sets 列表]] — 所有预定义风格集
- [[https://github.com/be5invis/Iosevka/blob/main/doc/character-variants.md][Character Variants 列表]] — 所有字符变体
- [[https://github.com/be5invis/Iosevka/blob/main/doc/language-specific-ligation-sets.md][语言特定连字集]] — 所有语言连字标签
- [[https://be5invis.github.io/Iosevka/customizer][Iosevka Customizer]] — 在线配置工具
- [[https://be5invis.github.io/Iosevka/specimen][Iosevka Specimen]] — 字体样本展示
- [[https://github.com/be5invis/Sarasa-Gothic][Sarasa Gothic]] — CJK 版本（Iosevka + 思源黑体）
- [[https://mirrors.tuna.tsinghua.edu.cn/github-release/be5invis/Iosevka][清华大学 TUNA 镜像]] — 国内下载加速
