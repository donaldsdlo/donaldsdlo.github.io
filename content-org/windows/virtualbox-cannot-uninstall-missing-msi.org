:PROPERTIES:
:ID:       c9404dda-dd1f-4283-9e1b-9b54326db66f
:END:
#+TITLE: 无法删除或重装VirtualBox，提示缺少msi安装包
#+HUGO_TAGS: Windows VirtualBox
...
#+BEGIN_QUOTE
单击"确定"重试，或在下面的框中输入包含安装程序包 ~VirtualBox-7.2.4-r170995-MultiArch_amd64.msi~ 的文件夹的路径。
#+END_QUOTE
...
从报错信息中我们可以看到，系统需要的是 =.msi= 格式的安装包文件，但当我们从 [[https://www.virtualbox.org/wiki/Download_Old_Builds_7_2][VirtualBox官网]] 下载旧版本时，下载的文件是 =.exe= 格式的，而不是 =.msi= 格式的。
...
#+DOWNLOADED: screenshot @ 2026-05-08 13:03:47
#+ATTR_ORG: :width 800
#+ATTR_HTML: :width 90%
#+ATTR_LATEX: :width 0.8\textwidth
[[file:../../static/content-org/windows/无法删除或重装VirtualBox，提示缺少msi安装包.org/2026-05-08_13-03-47_screenshot.png]]

*** 步骤3：找到MSI文件

解压完成后，进入刚才指定的 =temp= 文件夹，你会在其中找到所需的 =.msi= 文件以及其他必要的组件：

#+DOWNLOADED: screenshot @ 2026-05-08 13:04:06
#+ATTR_ORG: :width 800
#+ATTR_HTML: :width 90%
#+ATTR_LATEX: :width 0.8\textwidth
[[file:../../static/content-org/windows/无法删除或重装VirtualBox，提示缺少msi安装包.org/2026-05-08_13-04-06_screenshot.png]]
