:PROPERTIES:
:ID:       bb754098-0d89-4ef5-875a-d45c61c42dd4
:END:
#+TITLE: Windows 系统 Emacs 中的中文输入法切换
#+HUGO_TAGS: windows Emacs 输入法
#+CATEGORIES: windows Emacs 输入法
#+DATE: 2026-07-11
#+AUTHOR: Donald Lo
...
#+DOWNLOADED: screenshot @ 2026-07-11 09:21:08
#+ATTR_ORG: :width 800
#+ATTR_HTML: :width 90%
#+ATTR_LATEX: :width 0.8\textwidth
[[file:../../static/content-org/windows/chinese-input-method-switching-in-emacs-on-windows.org/2026-07-11_09-21-08_screenshot.png]]


#+DOWNLOADED: screenshot @ 2026-07-11 09:21:30
#+ATTR_ORG: :width 800
#+ATTR_HTML: :width 90%
#+ATTR_LATEX: :width 0.8\textwidth
[[file:../../static/content-org/windows/chinese-input-method-switching-in-emacs-on-windows.org/2026-07-11_09-21-30_screenshot.png]]


#+DOWNLOADED: screenshot @ 2026-07-11 09:21:56
#+ATTR_ORG: :width 800
#+ATTR_HTML: :width 90%
#+ATTR_LATEX: :width 0.8\textwidth
[[file:../../static/content-org/windows/chinese-input-method-switching-in-emacs-on-windows.org/2026-07-11_09-21-56_screenshot.png]]


#+DOWNLOADED: screenshot @ 2026-07-11 09:22:39
#+ATTR_ORG: :width 800
#+ATTR_HTML: :width 90%
#+ATTR_LATEX: :width 0.8\textwidth
[[file:../../static/content-org/windows/chinese-input-method-switching-in-emacs-on-windows.org/2026-07-11_09-22-39_screenshot.png]]

这条路解决的是"键位层面"，调度逻辑没变——你还是在手动切换，只是换了个手指组合。适合不想动 Emacs 配置的场景。

** rimel + Rime，让 Emacs 拿回控制权
:PROPERTIES:
:ID:       41d63f0b-6688-44aa-a898-f238755a3ff5
:END:
...
#+DOWNLOADED: screenshot @ 2026-07-11 09:44:58
#+ATTR_ORG: :width 800
#+ATTR_HTML: :width 90%
#+ATTR_LATEX: :width 0.8\textwidth
[[file:../../static/content-org/windows/chinese-input-method-switching-in-emacs-on-windows.org/2026-07-11_09-44-58_screenshot.png]]
...
#+DOWNLOADED: screenshot @ 2026-07-11 11:17:23
#+ATTR_ORG: :width 800
#+ATTR_HTML: :width 90%
#+ATTR_LATEX: :width 0.8\textwidth
[[file:../../static/content-org/windows/chinese-input-method-switching-in-emacs-on-windows.org/2026-07-11_11-17-23_screenshot.png]]
