...
* 输出一个 99 乘法表
:PROPERTIES:
:ID:       d1967d79-1632-4312-9968-a20647ca673d
:END:

#+ATTR_ORG: :width 800
#+ATTR_HTML: :width 90%
#+ATTR_LATEX: :width 0.8\textwidth
[[file:../../static/content-org/acm/0003-loop-practice.org/2026-03-03_21-42-04_screenshot.png]]
...
* 求如下表达式的值
:PROPERTIES:
:ID:       be2f9d43-2575-4458-8c07-5f166f292da2
:END:
...
** 3. 线性筛法 / 欧拉筛 (Linear Sieve / Euler Sieve)
...
* 冒泡排序
:PROPERTIES:
:ID:       6d6c8e51-5517-4cab-98b4-ebccccdd353a
:END:

[[file:../../static/content-org/acm/0003-loop-practice.org/v2-5a15e1d04745123a0cc6de5a90e881d9_b.gif]]
...
定义来自于[[https://en.wikipedia.org/wiki/Bubble_sort][维基百科，冒泡排序，Bubble Sort.]]

冒泡排序，有时被称为“下沉排序”(sinking sort)，是一种简单的排序算法，它反复地遍历列表进行排序，[[https://zhida.zhihu.com/search?content_id=8141823&content_type=Article&match_order=1&q=遍历过程&zhida_source=entity][遍历过程]]中比较每一对相邻的项，如果它们的顺序是相反的，则交换它们。对列表的遍历是持续进行的，一直到列表变成有序，不需要交换为止。该算法是一种比较排序，它以更小或更大的元素（根据实际情况而定）“冒泡”到列表顶部的方式命名。该算法的优点是很简单，通俗易懂；但对于大多数问题来说，它太费时间且不切实际。如果输入列表中大部分元素都是有序的，只有一些很少的无序元素，那么气泡排序是可行的。
...
#+CAPTION: 过程比较快，每次移动都是在对比后进行的
[[file:../../static/content-org/acm/0003-loop-practice.org/v2-9dd4ecd8b6cdea12a61f5faffbcfe411_b.gif]]
...
#+CAPTION: 动图图解比较慢，按照从小到大的顺序要求排列
[[file:../../static/content-org/acm/0003-loop-practice.org/v2-a4b8ad55cd4461c0173c92d7735bb106_b.gif]]

** 代码展示

*伪代码*

伪代码来源：[[https://www.algorithmist.com/index.php/Bubble_sort][Bubble sort - Algorithmist]]
...
2. 是否能再改进一些？
    ...
    引自 [[https://www.algorithmist.com/index.php/Bubble_sort][Bubble sort - Algorithmist]]
    #+end_quote
    *伪代码*
    #+begin_src c
    // 假设我们有一个array 名字是a，尺寸大小是n
...
* 选择排序
:PROPERTIES:
:ID: 8f7c9d62-6618-4dbc-89c5-fcdddded464b
:END:

[[file:../../static/content-org/acm/0003-loop-practice.org/selection-sort.gif]]
...
定义来自于[[https://en.wikipedia.org/wiki/Selection_sort][维基百科，选择排序，Selection Sort.]]
...
#+CAPTION: 每次选择最小的元素放到前面
[[file:../../static/content-org/acm/0003-loop-practice.org/selection-sort-animation.gif]]
...
#+CAPTION: 选择排序动态演示
[[file:../../static/content-org/acm/0003-loop-practice.org/selection-sort-demo.gif]]

** 代码展示

*伪代码*

伪代码来源：[[https://www.algorithmist.com/index.php/Selection_sort][Selection sort - Algorithmist]]
